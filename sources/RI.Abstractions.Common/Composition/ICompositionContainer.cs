...
namespace RI.Abstractions.Composition
{
    ...
    /// <remarks>
    ///     <note type="note">
    ///         <see cref="ICompositionContainer" /> is intended to be used by the domain service builder (<see cref="DomainServiceBuilder" />) exclusively and should therefore be registered using <see cref="CompositionRegistrationMode.None" />.
    ///     </note>
    /// </remarks>
