...
namespace RI.Abstractions.Dispatcher
{
    ...
    public static partial class IThreadDispatcherExtensions
    {
        ...
        IThreadDispatcherOperation Post(Delegate action, params object[] parameters);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="action" /> is null. </exception>
        /// <exception cref="InvalidOperationException"> The dispatcher is being shut down. </exception>
        IThreadDispatcherOperation Post(int priority, Delegate action, params object[] parameters);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="action" /> is null. </exception>
        /// <exception cref="InvalidOperationException"> The dispatcher is being shut down. </exception>
        IThreadDispatcherOperation Post(int priority, ThreadDispatcherOptions options, Delegate action, params object[] parameters);
        ...
        /// <summary>
        ///     Gets the <see cref="TaskFactory" /> associated with the dispatcher.
        /// </summary>
        /// <param name="dispatcher"> The dispatcher. </param>
        /// <returns>
        ///     The <see cref="TaskFactory" /> associated with the dispatcher or null if the dispatcher is not running.
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="dispatcher" /> is null. </exception>
        public static TaskFactory GetTaskFactory(this IThreadDispatcher dispatcher)
        {
            if (dispatcher == null)
            {
                throw new ArgumentNullException(nameof(dispatcher));
            ...
            lock (dispatcher.SyncRoot)
            {
                ...
                if (dispatcher is ThreadDispatcher)
                {
                    return ((ThreadDispatcher)dispatcher).Factory;
                }

                if (dispatcher is HeavyThreadDispatcher)
                {
                    return ((HeavyThreadDispatcher)dispatcher).Dispatcher.Factory;
                }
