...
{
    /// <summary>
    ///     Event arguments for the <see cref="IThreadDispatcher.Watchdog" /> event.
    /// </summary>
    ...
    public sealed class ThreadDispatcherWatchdogEventArgs : EventArgs
    {
        ...
        public ThreadDispatcherWatchdogEventArgs (TimeSpan timeout, IThreadDispatcherOperation currentOperation)
        {
