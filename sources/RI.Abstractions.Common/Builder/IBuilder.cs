...
namespace RI.Abstractions.Builder
{
    ...
    ///     </para>
    ///     <para>
    ///         <see cref="IBuilder" /> is intended for one-time use, meaning that a builder instance can only perform construction and configuration only once (using <see cref="Build" /> or <see cref="IBuilderExtensions.BuildStandalone" />).
    ///     </para>
    /// </remarks>
    public interface IBuilder
    {
        /// <summary>
        ///     Gets whether <see cref="Build" /> or <see cref="IBuilderExtensions.BuildStandalone" /> has already been called.
        /// </summary>
        /// <value>
        ///     true if <see cref="Build" /> or <see cref="IBuilderExtensions.BuildStandalone" /> was called, false otherwise.
        /// </value>
        ...
        /// </value>
        /// <exception cref="InvalidOperationException"> <see cref="Build" /> or <see cref="IBuilderExtensions.BuildStandalone" /> has already been called. </exception>
